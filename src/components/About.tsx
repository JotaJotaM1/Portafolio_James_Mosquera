...
export const About: React.FC<{ id?: string }> = ({ id }) => {
  ...
  const cvHref = isSpanish
    ? "/james-mosquera-cv-es.pdf"
    : "/james-mosquera-cv-en.pdf";
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              >
                ...
                {t("about.downloadCv").toUpperCase()}
              </a>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900 dark:bg-slate-800/80 text-white rounded-3xl p-10 md:p-14 shadow-2xl border border-slate-800/50">
              <div className="space-y-12">
                <div>
                  <div className="text-[10px] uppercase tracking-[0.2em] text-slate-400 font-bold mb-3">
                ...
                <div className="grid gap-8 sm:grid-cols-3" ref={statsRef}>
                  {stats.map((stat) => (
                    <div key={stat.label}>
                      ...
                      <div
                        className={`inline-flex items-baseline gap-2 text-4xl md:text-5xl font-display font-bold ${stat.accent ? "text-primary" : ""}`}
                      >
                        {stat.suffix === "Plus" ? (
                          <span>
